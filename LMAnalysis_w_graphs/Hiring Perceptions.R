...
setwd("~/Desktop/HP/Analysis")
Data <- read.csv("HiringPerceptionsData5.csv")
...
# #Leaving the Liberal Progressive Measures out at they don't hang together well, can look at them separately
# 
# ##Exploratory
# #First I'm going to check to see which distribution best fits the data that I'm working with
# 
# Data.Indeces <- cbind(Data$Condition, Data$AF_Qual, Data$AF_Stat, Data$AF_Amer, Data$AF_Warm, Data$AA_Qual, Data$AA_Stat, Data$AA_Amer, Data$AA_Warm)
# 
# Data.Indeces <- as.data.frame(Data.Indeces)
# variablenames <- c("Condition", "AF_Qual", "AF_Stat", "AF_Amer", "AF_Warm", "AA_Qual", "AA_Stat", "AA_Amer", "AA_Warm")
# names(Data.Indeces) <- variablenames
# 
# Data.Index <- cbind(Data$AF_Qual, Data$AF_Stat, Data$AF_Amer, Data$AF_Warm, Data$AA_Qual, Data$AA_Stat, Data$AA_Amer, Data$AA_Warm)
# 
# Data.Index <- as.data.frame(Data.Index)
# variablenames <- c("AF_Qual", "AF_Stat", "AF_Amer", "AF_Warm", "AA_Qual", "AA_Stat", "AA_Amer", "AA_Warm")
# names(Data.Index) <- variablenames
# 
# res <- cor(Data.Index, use = "complete.obs")
# round(res,2)
# 
# library(Hmisc)
# res2 <- rcorr(as.matrix(Data.Index), type = c("pearson","spearman"))
# res2
# 
# library(corrplot)
...
# 
# WARM <- factor(c("Warmth (AF)", "Warmth (AA)"))
...
# Anv1 <- lm(cbind(Data$AF_Qual, Data$AA_Qual, Data$AF_Amer, Data$AA_Amer, Data$AF_Stat, Data$AA_Stat, Data$AF_Warm, Data$AA_Warm)~Condition)
